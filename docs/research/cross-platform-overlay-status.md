...
`client.overlay.openAchievementsOverlay({ appId, presenter })`, which opens
...
callback. Keep dialog/social activation transparent; use `openFriendsOverlay`
for the product Friends List route.

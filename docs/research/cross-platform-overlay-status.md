...
6. Confirm `callback:microtxn` includes a presenter snapshot if authorization
   ...
   matching callback app ID, or lands outside the `openCheckoutAndWait(...)`
   lifecycle before checkout wait completion.

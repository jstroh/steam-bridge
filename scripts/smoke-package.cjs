...
function runWindowsSmokeHelperStaticChecks() {
  ...
  for (const expected of [
    ...
    "Resolve-InitTxnCapturePath",
    "validate-checkout-target.cjs",
    "init-client-txn.cjs",
    "Validated Windows checkout JSON target",
    "Captured Windows InitTxn checkout JSON: source=init-txn-request-file output=present expectedAppId=checked",
    ...
    "steam-bridge-windows-init-txn-capture",
    "initTxnCapture",
    "apiKeyEnvProvided",

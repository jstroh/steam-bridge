...
[![License: MIT](https://img.shields.io/npm/l/steam-bridge)](https://github.com/jstroh/steam-bridge/blob/main/LICENSE)
...
| --- | --- |
| Connect a Node game, use Steam services, or understand lifecycle | [Getting started](https://github.com/jstroh/steam-bridge/blob/main/docs/getting-started.md) |
| Add Steam to an Electron game | [Electron integration](https://github.com/jstroh/steam-bridge/blob/main/docs/electron.md) |
| Read controllers, bind actions, or display button glyphs | [Steam Input and renderer input](https://github.com/jstroh/steam-bridge/blob/main/docs/steam-input.md) |
| Ship an Electron game on Steam | [Packaging your game](https://github.com/jstroh/steam-bridge/blob/main/docs/packaging.md) |
| Diagnose initialization, input, overlay, or frame-delivery problems | [Troubleshooting](https://github.com/jstroh/steam-bridge/blob/main/docs/troubleshooting.md) |
| Find a lower-level Steamworks API | [API coverage](https://github.com/jstroh/steam-bridge/blob/main/docs/steam-api-coverage.md) |
| Work on this library | [Contributing](https://github.com/jstroh/steam-bridge/blob/main/CONTRIBUTING.md) |
| Publish a new Steam Bridge package | [Maintainer release procedure](https://github.com/jstroh/steam-bridge/blob/main/RELEASING.md) |
...
navigation. The [Electron guide](https://github.com/jstroh/steam-bridge/blob/main/docs/electron.md) shows the sequence.
...
same unsafe-error rule. See [texture ownership](https://github.com/jstroh/steam-bridge/blob/main/docs/electron.md#windows-texture-ownership)
...
[advanced QA harness](https://github.com/jstroh/steam-bridge/blob/main/examples/electron-basic/README.md) is a qualification tool,
...
[code signing policy](https://github.com/jstroh/steam-bridge/blob/main/CODE_SIGNING_POLICY.md) and [privacy policy](https://github.com/jstroh/steam-bridge/blob/main/PRIVACY.md).
...
[MIT](https://github.com/jstroh/steam-bridge/blob/main/LICENSE). Steamworks use remains subject to Valve's terms.

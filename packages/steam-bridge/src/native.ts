...
export interface NativeBinding {
  ...
  musicRemoteRegister(name: string): boolean;
  musicRemoteDeregister(): boolean;
  musicRemoteIsCurrent(): boolean;
  musicRemoteActivationSuccess(value: boolean): boolean;
  musicRemoteSetDisplayName(displayName: string): boolean;
  musicRemoteSetPngIcon64x64(data: Buffer): boolean;
  musicRemoteEnablePlayPrevious(value: boolean): boolean;
  musicRemoteEnablePlayNext(value: boolean): boolean;
  musicRemoteEnableShuffled(value: boolean): boolean;
  musicRemoteEnableLooped(value: boolean): boolean;
  musicRemoteEnableQueue(value: boolean): boolean;
  musicRemoteEnablePlaylists(value: boolean): boolean;
  musicRemoteUpdatePlaybackStatus(status: number): boolean;
  musicRemoteUpdateShuffled(value: boolean): boolean;
  musicRemoteUpdateLooped(value: boolean): boolean;
  musicRemoteUpdateVolume(volume: number): boolean;
  musicRemoteCurrentEntryWillChange(): boolean;
  musicRemoteCurrentEntryIsAvailable(available: boolean): boolean;
  musicRemoteUpdateCurrentEntryText(text: string): boolean;
  musicRemoteUpdateCurrentEntryElapsedSeconds(value: number): boolean;
  musicRemoteUpdateCurrentEntryCoverArt(data: Buffer): boolean;
  musicRemoteCurrentEntryDidChange(): boolean;
  musicRemoteQueueWillChange(): boolean;
  musicRemoteResetQueueEntries(): boolean;
  musicRemoteSetQueueEntry(id: number, position: number, entryText: string): boolean;
  musicRemoteSetCurrentQueueEntry(id: number): boolean;
  musicRemoteQueueDidChange(): boolean;
  musicRemotePlaylistWillChange(): boolean;
  musicRemoteResetPlaylistEntries(): boolean;
  musicRemoteSetPlaylistEntry(id: number, position: number, entryText: string): boolean;
  musicRemoteSetCurrentPlaylistEntry(id: number): boolean;
  musicRemotePlaylistDidChange(): boolean;
  ...
  gameServerNetworkingSocketsCreateListenSocketIp(address: NativeNetworkingIpAddress, options?: NativeNetworkingConfigValue[]): number;
  gameServerNetworkingSocketsConnectByIpAddress(address: NativeNetworkingIpAddress, options?: NativeNetworkingConfigValue[]): number;
  gameServerNetworkingSocketsCreateListenSocketP2p(localVirtualPort?: number, options?: NativeNetworkingConfigValue[]): number;
  gameServerNetworkingSocketsConnectP2p(identity: NativeNetworkingIdentity, remoteVirtualPort?: number, options?: NativeNetworkingConfigValue[]): number;
  gameServerNetworkingSocketsConnectP2pCustomSignaling(signalingPointer: bigint, peerIdentity?: NativeNetworkingIdentity | null, remoteVirtualPort?: number, options?: NativeNetworkingConfigValue[]): number;
  ...
  gameServerNetworkingSocketsConnectToHostedDedicatedServer(identity: NativeNetworkingIdentity, remoteVirtualPort?: number, options?: NativeNetworkingConfigValue[]): number;
  ...
  gameServerNetworkingSocketsCreateHostedDedicatedServerListenSocket(localVirtualPort?: number, options?: NativeNetworkingConfigValue[]): number;
  ...
  gameServerNetworkingSocketsCreateListenSocketP2pFakeIp(idxFakePort?: number, options?: NativeNetworkingConfigValue[]): number;
  ...
  networkingSocketsCreateListenSocketIp(address: NativeNetworkingIpAddress, options?: NativeNetworkingConfigValue[]): number;
  networkingSocketsConnectByIpAddress(address: NativeNetworkingIpAddress, options?: NativeNetworkingConfigValue[]): number;
  networkingSocketsCreateListenSocketP2p(localVirtualPort?: number, options?: NativeNetworkingConfigValue[]): number;
  networkingSocketsConnectP2p(identity: NativeNetworkingIdentity, remoteVirtualPort?: number, options?: NativeNetworkingConfigValue[]): number;
  networkingSocketsConnectP2pCustomSignaling(signalingPointer: bigint, peerIdentity?: NativeNetworkingIdentity | null, remoteVirtualPort?: number, options?: NativeNetworkingConfigValue[]): number;
  ...
  networkingSocketsConnectToHostedDedicatedServer(identity: NativeNetworkingIdentity, remoteVirtualPort?: number, options?: NativeNetworkingConfigValue[]): number;
  ...
  networkingSocketsCreateHostedDedicatedServerListenSocket(localVirtualPort?: number, options?: NativeNetworkingConfigValue[]): number;
  ...
  networkingSocketsCreateListenSocketP2pFakeIp(idxFakePort?: number, options?: NativeNetworkingConfigValue[]): number;
